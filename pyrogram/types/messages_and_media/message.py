...
from typing import Any, Tuple, List, Match, Union, BinaryIO, Optional, Callable, Dict
...
class Message(Object, Update):
    ...
    def __init__(
        ...
        *,
        ...
        general_topic_hidden: Optional["types.GeneralTopicHidden"] = None,
        general_topic_unhidden: Optional["types.GeneralTopicUnhidden"] = None,
        ...
        requested_chats: Optional["types.RequestedChats"] = None,
        ...
        chat_ttl_period: Optional[int] = None,
