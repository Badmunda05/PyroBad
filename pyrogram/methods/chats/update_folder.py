...
class UpdateFolder:
    async def update_folder(
        ...
        included_chats: Optional[Union[Union[int, str], List[Union[int, str]]]] = None,
        excluded_chats: Optional[Union[Union[int, str], List[Union[int, str]]]] = None,
        pinned_chats: Optional[Union[Union[int, str], List[Union[int, str]]]] = None,
